...
#Notes: replace.pl (added) is a perl script to replace Uniprot ID with Gene and species name by using a file
 called Uniprot_Species_file 
...
#change the name of fasta to GeneName_Species (replace.pl and Uniprot_GeneName_Species files are in the fold
er)
