...
### Load .bam files of IP samples placed in the folder in which the script is being run

bamFiles <- Rsamtools::BamFileList(c("Heart_WT_rep1.bam", "Heart_WT_rep2.bam", "Heart_WT_rep4.bam", "Heart_KO_rep1.bam", "Heart_KO_rep2.bam", "Heart_KO_rep4.bam"))
